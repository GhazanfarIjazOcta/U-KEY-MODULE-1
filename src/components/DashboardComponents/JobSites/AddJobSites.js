...
function AddJobSites() {
  ...
  const [selectedLocation, setSelectedLocation] = useState({ lat: 51.505, lng: -0.09 }); // Default to center map location
  const { user } = useUser();
  ...
  useEffect(() => {
    const fetchJobSites = async () => {
      const jobSitesRef = ref(rtdb, `organizations/${CurrentOrganizationID}/JobSites`);
  ...
  const handleAddJobSite = async () => {
    try {
      ...
      const newJobSite = {
        ...
        locationURL: `https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d${selectedLocation.lat}!2d${selectedLocation.lng}!3d${selectedLocation.lat}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c24fa5d33f083b%3A0xd3cf0b0078a0e217!2s${encodeURIComponent(formData.locationName)}!5e0!3m2!1sen!2sus!4vYOUR_EMBED_API_KEY`,
        status: formData.status,
      };

      // Add the new job site and filter out null values before updating
      const updatedJobSites = [...jobSites, newJobSite].filter(site => site !== null);
      const jobSitesRef = ref(rtdb, `organizations/${CurrentOrganizationID}/JobSites`);
      ...
      setFormData({ companyName: "", locationName: "", locationURL: "", status: "Active" });
  ...
  return (
    <Paper sx={{ padding: 3 }}>
        ...
        {["companyName", "locationName", "locationURL"].map((field) => (
          <Box key={field} sx={{ marginBottom: 2 }}>
            ...
            {field === "locationURL" ? (
              <TextField
                name={field}
                value={`https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d${selectedLocation.lat}!2d${selectedLocation.lng}!3d${selectedLocation.lat}!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x89c24fa5d33f083b%3A0xd3cf0b0078a0e217!2s${encodeURIComponent(formData.locationName)}!5e0!3m2!1sen!2sus!4vYOUR_EMBED_API_KEY`}
                fullWidth
                disabled
      ...
      <Box sx={{ marginBottom: 2 }}>
  <Typography sx={{mb:1}}>Location Will be selected on basis of Location Name:</Typography>
  <MapContainer
  ...
  >
    ...
    <Marker position={selectedLocation}>
      ...
      <Stack direction="row" justifyContent="flex-end">
        <Button sx={{backgroundColor: "#15294E"}} variant="contained" onClick={handleAddJobSite}>
          Add Job Site
        </Button>
      </Stack>
